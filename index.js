...
// Lexical scoping allows nested functions to use the outer functions variables. 
...
const cuboid1 = new CuboidMaker({length: 4, width: 5, height: 6})
console.log('cuboid',cuboid1);
...
console.log('volume is', cuboid1.volume())
